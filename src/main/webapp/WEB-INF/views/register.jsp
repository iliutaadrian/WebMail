...
<div class="container text-center">
    ...
    <pr:choose>
        <pr:when test="${mode=='MODE_ERROR' }">
            <h5 style="color: red">Wrong register info</h5>
            <hr>
        </pr:when>
    </pr:choose>
    ...
    <pr:choose>
        <pr:when test="${mode=='MODE_OK' }">
            <h5 style="color: red">Account created successfully. You can log in.</h5>
            <hr>
        </pr:when>
    </pr:choose>
    ...
    <form class="form-horizontal" method="POST" action="/register-user">
        ...
        <div class="form-group">
            <label class="control-label col-md-4">Paste URL with profile picture</label>
            <div class="col-md-5">
