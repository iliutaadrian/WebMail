...
<div class="container text-center">
    ...
    <form class="form-horizontal" method="POST" action="/send-email">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" value="${addressReceiver}" readonly />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" value="${subjectMail}" readonly/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8" >
                <textarea  style="height: 250px; resize: none" class="form-control" readonly>${bodyMail}</textarea>
            </div>
        </div>
    </form>
</div>
